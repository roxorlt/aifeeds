...
test('suppressCrossDayRepeatedNewsEvents keeps an actual open-weight release after an earlier upcoming-model preview', () => {
  const candidates = [
    row({
      ...
      titleZh: '月之暗面开源 Kimi K3 模型 性能比肩美国顶尖 AI',
      sourceCompany: 'The Verge',
      sourceKey: 'the-verge',
      aiCategory: 'model-release',
  ...
  const prior = [
    ...
    row({
      id: 'blog:aiera:kimi-pricing-context',
      title: 'Kimi逼得两大巨头改变定价！奥特曼罕见认错，Claude额度重置',
      titleZh: 'OpenAI与Anthropic竞相调整使用额度 智能体数据争夺战升级',
      sourceCompany: '新智元',
      aiCategory: 'company',
      publishedAt: '2026-07-19T02:00:00.000Z',
      aiSummaryZh: '智能体竞赛白热化，OpenAI和Anthropic通过调整使用额度抢夺数据和用户，同时用新指标重新定义AI性价比。',
    }),
    row({
      id: 'blog:techcrunch:moonshot-sanctions',
      title: 'Treasury threatens sanctions after White House claims Moonshot distilled Anthropic’s Fable',
      titleZh: '美财政部威胁制裁 指Moonshot蒸馏Anthropic Fable模型',
      sourceCompany: 'TechCrunch',
      aiCategory: 'safety',
      publishedAt: '2026-07-23T10:00:00.000Z',
      aiSummaryZh: '美国指控中国AI公司通过模型蒸馏窃取技术，可能升级制裁，凸显AI知识产权争夺与出口管制新冲突。',
    }),
    row({
      id: 'blog:openai:gpt56-copilot-integration',
      title: 'GPT-5.6 is now the preferred model in Microsoft 365 Copilot',
      titleZh: 'GPT-5.6成为Microsoft 365 Copilot首选模型',
      sourceCompany: 'OpenAI',
      sourceKey: 'openai',
      aiCategory: 'model-release',
      publishedAt: '2026-07-09T13:00:00.000Z',
      aiSummaryZh: 'OpenAI推出GPT-5.6，微软365 Copilot全面采用，办公AI能力再升级。',
      eventFingerprint: {
        eventType: 'infrastructure_integration',
        primaryActor: 'OpenAI',
        primaryObject: 'GPT-5.6',
        objectFamily: 'GPT',
        objectVersion: '5.6',
        action: 'integrate',
        canonicalEvent: 'GPT-5.6 integrated as preferred model in Microsoft 365 Copilot',
        confidence: 0.95,
      },
    }),
    row({
